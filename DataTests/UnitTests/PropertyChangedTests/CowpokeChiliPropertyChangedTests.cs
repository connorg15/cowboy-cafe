...
namespace CowboyCafe.DataTests.UnitTests
{
    public class CowpokeChiliPropertyChangedTests
    {
        ...
        // Test 9: Changing the "Bread" property should invoke the PropertyChanged for "SpecialInstructions"
        [Fact]
        public void ChangingTorillaStripsShouldInvokePropertyChangedForSpecialInstructions()
        {
            var chili = new CowpokeChili();
            Assert.PropertyChanged(chili, "SpecialInstructions", () =>
            {
